...
class ConfigData
{
    public const GENERAL_POPUP_ENABLED = 'general/popup_enabled';
    public const GENERAL_MODULE_ENABLED = 'general/enabled';
    public const GENERAL_REDIRECT_TYPE = 'general/redirect_type';
    public const GENERAL_CLOSE_WHEN_CLICKED_OUTSIDE = 'general/close_when_clicked_outside';
    public const LINKEDIN_PROVIDER = 'linkedin/provider';
    ...
    public function getLinkedinProvider(): string
    {
        return (string)$this->getConfigValue(self::LINKEDIN_PROVIDER);
    }
}
