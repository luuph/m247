...
namespace Biztech\Translator\Block\Adminhtml\MasstranslateInMultiStoreProducts;
...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    public function __construct(
        ...
        \Biztech\Translator\Model\MasstranslateinAllstoreFactory $collectionFactory,
    ...
    {
        return $this->getUrl('*/*/translateinmultiplestoregrid', ['_current' => true]);
    }
    ...
    protected function _construct()
    {
        ...
        $this->setId('masstranslateinmultistoreproductsGrid');
        ...
        $this->addColumn(
            ...
            [
                ...
                'index' => 'translated',
                 'filter' => false,
                'sortable' => false,
                'renderer' => 'Biztech\Translator\Block\Adminhtml\Crondata\Renderer\TranslationInAllStoreStatus'
            ]
        );
