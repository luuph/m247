...
class NewAddedProductTranslateInAllStoreTolang extends \Magento\Ui\Component\Listing\Columns\Column
{
    ...
    public function __construct(
        ...
        $this->masstranslateNewlyAddedProductsFactory = $masstranslateNewlyAddedProductsFactory;
    ...
    public function prepareDataSource(array $dataSource)
    {
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as & $item) {
                ...
                $stores = json_decode($this->masstranslateNewlyAddedProductsFactory->create()->load($item['id'])->getStoreIds());
                $store_view = '';
