...
class Token extends \Magento\Integration\Model\Oauth\Token
{
     ...
     * @return $this
     */
    public function createSubUserToken($subId, $customerId = 0)
    {
        $this->setSubUserId($subId);
        $this->setCustomerId($this->getCustomerId() ?? $customerId);
        return $this->saveAccessToken(TokenSubUserContext::USER_TYPE_CUSTOMER);
    }
}
