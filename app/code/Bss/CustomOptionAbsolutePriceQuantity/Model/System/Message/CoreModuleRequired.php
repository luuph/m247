...
namespace Bss\CustomOptionAbsolutePriceQuantity\Model\System\Message;

class CoreModuleRequired implements \Magento\Framework\Notification\MessageInterface
{
    const MESSAGE_IDENTITY = 'bss_option_core_module_required_of_abs';
    const BSS_OPTION_CORE_MODULE_NAME = 'Bss_CustomOptionCore';
    const MODULE_NAME = 'Bss_CustomOptionAbsolutePriceQuantity';
