...
class ConfigurableProduct extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    public function getMultiChildProductData($parentProductId, $productListParams)
    {
        ...
        foreach ($productListParams as $productParam) {
            ...
            $qty_increments = $stockItem->getQtyIncrements() ? $stockItem->getQtyIncrements() : 1;
            $qty = $productParam['qty'];
            if($qty < $qty_increments) {
                $is_validate = false;
            }
            ...
            $childProductData['qty_increments'] = $qty_increments;
            ...
            $childProductData['product_request_4_quote'] = $parentProduct->getIsActiveRequest4Quote() ? 1 : 0;
            ...
            $productDataArray[] = $childProductData;
        }
        $result['is_validate'] = $is_validate;
        $result['product_data'] = $productDataArray;
