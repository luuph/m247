...
class Extract extends Action
{
     ...
     * @param \Bss\GeoIPAutoSwitchStore\Helper\Config $geoIpConfigHelper
    ...
    public function __construct(
        ...
        \Bss\GeoIPAutoSwitchStore\Helper\Config $geoIpConfigHelper,
    ...
    {
        $fileCustom = $this->geoIpConfigHelper->getUrlCustom();
