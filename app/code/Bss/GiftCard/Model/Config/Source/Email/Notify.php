 ...
 */
class Notify extends DataObject implements ArrayInterface
{
    /**
     * @var Config
     */
    ...
    public function toOptionArray()
    {
        ...
        $templateLabel = $this->emailConfig->getTemplateLabel('bss_giftcard_notify_to_recipient');
        $templateLabel = __('%1 (Default)', $templateLabel);
        array_unshift($options, ['value' => 'bss_giftcard_notify_to_recipient', 'label' => $templateLabel]);
        return $options;
    }
}
