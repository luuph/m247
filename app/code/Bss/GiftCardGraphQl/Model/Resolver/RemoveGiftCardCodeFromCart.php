...
class RemoveGiftCardCodeFromCart implements ResolverInterface
{
    /**
     * @var GetCartForUser
     */
    ...
    public function resolve(Field $field, $context, ResolveInfo $info, array $value = null, array $args = null)
    {
        ...
        if (empty($args['input']['gift_card_quote_code'])) {
            throw new GraphQlInputException(__('Required parameter "gift_card_quote_code" is missing'));
        }
        $giftCardQuoteCode = $args['input']['gift_card_quote_code'];
        ...
        $this->giftCard->removeGiftCodeFromQuote($cart, $giftCardQuoteCode);
        return [
            'success' => true,
