 ...
 * Class index
 *
 * Bss\RewardPoint\Controller\Adminhtml\Rate
 */
class Index extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        $resultPage->addBreadcrumb(__('Exchange rates'), __('Exchange rates'));
        $resultPage->addBreadcrumb(__('Manage Exchange rates'), __('Manage Exchange rates'));
