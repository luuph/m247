...
class ModuleConfig extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    /**
     * Check config Use Flat Catalog Product
     *
     * @return mixed
     * @throws \Magento\Framework\Exception\NoSuchEntityException
     */
    public function isEnableCatalogFlat()
    {
        return $this->scopeConfig->getValue('catalog/frontend/flat_catalog_product', \Magento\Store\Model\ScopeInterface::SCOPE_STORE, $this->getStoreId());
    }
    ...
    public function getAllConfig()
    {
        ...
        $result['CurrencyCode'] = $this->getCurrencyCode();
        ...
        if ($result['enabled']) {
            ...
            $result['display_both_prices'] = $this->isDisplayBothPrices();
        } else {
            $result['sku'] = 0;
            $result['name'] = 0;
            $result['desc'] = 0;
    ...
    /**
     * Check is enable Bss_FacebookPixel and has Bss_FacebookPixel module
     *
     * @return bool
     */
    public function isEnableFaceBookPixel()
    {
        if ($this->moduleManager->isEnabled('Bss_FacebookPixel') &&
            $this->getValueofConfig('bss_facebook_pixel/general/active')
        ) {
            return true;
        }
        return false;
    ...
    /**
     * Check from config if display both included and excluded prices
     *
     * @return bool
     */
    public function isDisplayBothPrices()
    {
        return (int)$this->getValueofConfig(Config::CONFIG_XML_PATH_PRICE_DISPLAY_TYPE) == Config::DISPLAY_TYPE_BOTH;
    }
}
