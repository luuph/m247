...
namespace MagePsycho\RegionCityPro\Model\Config;
...
class ModuleMetadata implements ModuleMetadataInterface
{
    ...
    public const PRODUCT_NAME = 'Region & City Dropdown Manager';
    public const PRODUCT_URL = 'https://www.magepsycho.com/magento2-region-city-dropdown-manager.html';
    public const MODULE_NAME = 'MagePsycho_RegionCityPro';
    public const VERSION_CACHE_KEY = 'magepsycho-regioncitypro-module-version';
