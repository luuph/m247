...
{
    const XML_WHATSAPP_API_CLIENT_ID = 'whatsappultimate/smsgatways/whatsappapiclientid';
    const XML_WHATSAPP_API_INSTANCE = 'whatsappultimate/smsgatways/whatsappapiinstance';
    const XML_WHATSAPP_API_URL = 'whatsappultimate/smsgatways/whatsappapiurl';
