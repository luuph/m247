...
class ShipmentNotifier implements ResolverInterface
{
    ...
    {
        try {
            if (empty($args['shipmentId']) || empty($args['isresend'])) {
                throw new GraphQlInputException(__('Invalid parameter list.'));
            }
            $response=$this->ultimateInterface->sendShipmentNotification($args['shipmentId'],$args['isresend']);
