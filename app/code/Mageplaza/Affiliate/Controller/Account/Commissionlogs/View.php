...
namespace Mageplaza\Affiliate\Controller\Account\Commissionlogs;

use Mageplaza\Affiliate\Controller\Account;

/**
 * Class View
 * @package Mageplaza\Affiliate\Controller\Account\Commissionlogs
 */
class View extends Account
{
    ...
    public function execute()
    {
        ...
        if (!$withdraw || !$withdraw->getId() || $withdraw->getCustomerId() !== $customerId) {
            ...
            return $this->_redirect('*/account/commissionlogs');
        }
