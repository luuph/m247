...
namespace Mageplaza\Affiliate\Model\ResourceModel\Campaign\Api;
 ...
 * Class Collection
 * @api
 * @package Mageplaza\Affiliate\Model\ResourceModel\Campaign\Api
 */
class Collection extends AbstractCollection implements WithdrawSearchResultInterface
{
    ...
    {
        $this->_init(
            'Mageplaza\Affiliate\Model\Api\Campaign',
            'Mageplaza\Affiliate\Model\ResourceModel\Campaign'
        );
    }
}
