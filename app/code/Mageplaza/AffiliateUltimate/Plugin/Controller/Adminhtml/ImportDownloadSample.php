...
namespace Mageplaza\AffiliateUltimate\Plugin\Controller\Adminhtml;
...
class ImportDownloadSample
{
     ...
     * Module name
     */
    const SAMPLE_FILES_MODULE = 'Mageplaza_AffiliateUltimate';
    ...
    {
        $files = ['mp_affiliate_account', 'mp_affiliate_transaction'];
