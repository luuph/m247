                    ...
                    element.on('value', function () {
                        ...
                        if (self.isFormInline()) {
                            ...
                            if ($.inArray(element.index, observableElements) !== -1 && self.oscValidateAddressData(element.index, addressFlat)) {
                                ...
                                var configLoading =  window.loadingSpeedConfig;
                                if (configLoading && configLoading.refresh_page !== '1') {
                                    self.validateAddressTimeout = setTimeout(function () {
                                        if (configLoading.shipping_address_change.includes('1')) {
                                            window.loadingSpeedConfig.checkLoadingOrderSummary = "2";
                                            shippingRateService.estimateShippingMethod();
                                            window.loadingSpeedConfig.checkLoadingOrderSummary = "";
                                        }
                                        if (configLoading.shipping_address_change.includes('2')){
