...
namespace Magetrend\NewsletterMaker\Block\Adminhtml\Config;
...
{
    const MODULE_NAMESPACE = 'Magetrend_NewsletterMaker';

    const CONFIG_NAMESPACE = 'newslettermaker';

    const XML_PATH_GENERAL = 'newslettermaker/general/is_active';
