...
class Processor extends \Magezon\Core\Model\ConditionsProcessor
{
    ...
    protected function _saveTabRuleProduct($profile, $collection, $store)
    {
        $profileId = $profile->getId();
        $table = $this->_resource->getTableName('mgz_lookbook_profile_product');
        ...
        $where = ['profile_id = ?' => $profileId, 'store_id = ?' => $store->getId()];
