...
namespace Magezon\LookBook\Ui\DataProvider\Profile\Listing;
    ...
    public function addFilter(\Magento\Framework\Api\Filter $filter)
    {
        if ($filter->getField() == 'category_id') {
            $this->getCollection()->getSelect()->joinLeft(
                ['mlpc' => $this->getCollection()->getResource()->getTable('mgz_lookbook_profile_category')],
            ...
            $this->getCollection()->getSelect()->where('title LIKE (?)', '%' . $filter->getValue() . '%')->group('main_table.profile_id');
        } else {
