...
class AjaxResponseService
{
    ...
    private function buildDataInstantMode(Page $page)
    {
        ...
        $filterExpanderHtml  = $this->getBlockHtml($page, 'mst-nav.filterExpander', 'mst-nav.filterExpander.hyva');
    ...
    {
        if ($this->request->getFullActionName() === 'catalogsearch_result_index' || $this->config->isPreCalculationEnabled()) {
