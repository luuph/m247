...
## [2.2.9] - 2024-04-30
- New feature: add an option to the admin setting page to redirect the failed payment to the cart page or the failure page
- New feature: add the online refund with its webhook
- Fix shipping calculation

## [2.2.8] - 2024-04-30
- Fix Apple Pay registration
- Translate the currency of the payment gateways on the checkout page
- Translate the card view strings
- Fix the CSP configuration for magento2.4.7
...
[2.2.9]: https://dev.azure.com/myfatoorahsc/Public-Repo/_git/Magento2-Gateway?version=GT2.2.9
[2.2.8]: https://dev.azure.com/myfatoorahsc/Public-Repo/_git/Magento2-Gateway?version=GT2.2.8
