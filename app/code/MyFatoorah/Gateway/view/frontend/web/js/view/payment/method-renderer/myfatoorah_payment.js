                        ...
                        style: {
                            ...
                            input: {
                                ...
                                placeHolder: {
                                    ...
                                    securityCode: $.mage.__('Card CVV')
                                }
                            },
                            text: {
                                saveCard: $.mage.__('Save card no. for future payments'),
                                addCard: $.mage.__('Use another Card'),
                                deleteAlert: {
                                    title: $.mage.__('Delete Card'),
                                    message: $.mage.__('Are you sure you want to remove this Card?'),
                                    confirm: $.mage.__('Yes'),
                                    cancel: $.mage.__('No')
                                }
                            },
                            label: {
                                ...
                                fontFamily: "sans-serif",
                                text: {
                                    holderName: $.mage.__('Card Holder Name'),
                                    cardNumber: $.mage.__('Card Number'),
                                    expiryDate: $.mage.__('Expiry Date'),
                                    securityCode: $.mage.__('Card CVV')
                                }
                            },
                            error: {
