...
class Helper extends AbstractHelper
{
    ...
    public function isMobileTheme(){
        return $this->coreHelper->isMobileTheme();
    }
    /**
     * @return bool
     */
    public function isLazyLoadEnabled()
    {
        return $this->getSystemValue(Helper::XML_ENABLED)
            ...
            && $this->coreHelper->isLazyLoadEnabled();
    }
    ...
    public function isCurrentUrlMatch($url)
    {
    ...
    public function encrypt_save($a)
    {
        ...
        $b = json_decode((string)$a);
        $c = $this->load_decrypt();
        $d = $c !== false ? json_decode((string)$c) : $c;
        $e = static::STORE_CODE;
        // Save license string
        $this->configFactory()->saveConfig(
            base64_decode('YXRobGV0ZTJfbGljZW5zZS9nZW5lcmFsL2xpY2Vuc2U='),
