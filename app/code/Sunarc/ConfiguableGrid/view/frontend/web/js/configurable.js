            ...
            $(document).ready(
                function () {
                     ...
                     */
                          ...
                          {
                              var i_val = "";
                              i_val=$("#super_group_qty_"+up_pid).val();
                              
                              if(i_val=="")
                              {
                                  $("#super_group_qty_"+up_pid).val(1); 
                              }
                              else{
                                  $("#super_group_qty_"+up_pid).val(parseInt(i_val)+parseInt(1));
                              }
                          }
                          function decincrement(dec_pid)
                          {
                            var d_val=$("#super_group_qty_"+dec_pid).val();
                              if(parseInt(d_val)>0)
                              {
                                  $("#super_group_qty_"+dec_pid).val(parseInt(d_val)-parseInt(1));
                              }
                              if(parseInt(d_val)<0)
                              {
                                  $("#super_group_qty_"+dec_pid).val("0");
                              }
                          }
                         
                          // $(".addQty").click(function(){  
                          //     console.log("Yes I am");
                          //     var i_productid=$(this).attr("pro-id");
                            
                          //     console.log(i_productid);
          
                          //     upincrement(i_productid);
                                                              
                          // });
                        //   $(".minusQty").click(function(){  
                        //       var d_productid=$(this).attr("pro-id");
                        //       decincrement(d_productid);
                                                            
                        //   });
                              $(".addQty").click(function(){ 
                                var i_productid=$(this).attr("pro-id");
                              
            var isDisabled = $('#super_group_qty_'+i_productid).prop('disabled');
            if(isDisabled){
                return;
            }
                                upincrement(i_productid);
                            var confi_qty_value = $('#super_group_qty_'+i_productid).val();
                            ...
                            var productId = $('#super_group_qty_'+i_productid).attr("productId");
                            var indexField = i_productid;
                            ...
                            var trElement = $('#super_group_qty_'+i_productid).parent().parent();
                            var index = $('super_group_qty_'+i_productid).attr('index');
                               ...
                               var counter = 0;
                                $('#bss_configurablegridview .qty_att_product').each(
                                    function () {
                                        ...
                                        var eachQty = parseFloat($('#super_group_qty_'+counter).val());

                                        var firstAttr = $('#super_group_qty_'+counter).parent().parent().find('.first-attr');
                                        var firstId = firstAttr.attr('attribute-id');
                                        var firstValue = firstAttr.attr('attribute-value');
                    ...
                    $(".minusQty").click(function(){  
                        var d_productid=$(this).attr("pro-id");
                        decincrement(d_productid);
                    var confi_qty_value = $('#super_group_qty_'+d_productid).val();
                    ...
                    var productId = $('#super_group_qty_'+d_productid).attr("productId");
                    var indexField = d_productid;
                    ...
                    var trElement = $('#super_group_qty_'+d_productid).parent().parent();
                    var index = $('super_group_qty_'+d_productid).attr('index');
