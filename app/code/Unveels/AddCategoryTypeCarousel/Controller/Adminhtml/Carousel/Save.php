...
namespace Unveels\AddCategoryTypeCarousel\Controller\Adminhtml\Carousel;

use Webkul\MobikulCore\Controller\Adminhtml\Carousel\Save as BaseSave;
        ...
        if ($originalRequestData) {
            try {
                ...
                if ($carouselData["type"] == 1) {
                    ...
                    $carouselData["number_of_products"] = "";
                } else if($carouselData["type"] == 2) {
                    $carouselData["image_ids"] = "";
                    $carouselData["image_size"] = "";
                    $carouselData["categories"] = "";
                    $carouselData["number_of_products"] = "";
                } else {
                    $carouselData["product_ids"] = "";
