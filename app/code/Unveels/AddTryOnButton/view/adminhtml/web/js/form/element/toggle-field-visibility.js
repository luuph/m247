define([
    ...
    return select.extend({
        ...
        toggleFieldVisibility: function (value) {
            ...
            // Use uiRegistry to find the image_size field
            var fieldImageSize = uiRegistry.get('index = image_size');
            console.log("Retrieved fieldImageSize:", fieldImageSize);

            // Ensure the field is found and has the 'visible' function
            if (fieldImageSize && typeof fieldImageSize.visible === 'function') {
                ...
                console.error("Could not find image_size field or field does not have visible method.");
            }
        }
    });
});
