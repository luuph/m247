...
namespace Unveels\LookBookApi\Model;

use Unveels\LookBookApi\Api\LookBookCategoryInterface;
...
class LookBookCategory implements LookBookCategoryInterface
{
    /**
