...
{
    /**
     * Place an order and split it by individual items.
     *
     * @param int $cartId
    ...
    public function placeOrder($cartId, PaymentInterface $paymentMethod = null)
    {
        ...
        foreach ($quote->getAllItems() as $item) {
            // Initialize a new quote for each item
            ...
            $itemPrice = $item->getPrice(); // Get the price of the item
            ...
            // Set the subtotal and grand total for the split quote
            $subtotal = $itemPrice;
