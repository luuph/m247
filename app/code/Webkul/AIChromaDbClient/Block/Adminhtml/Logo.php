 ...
 */
namespace Webkul\AIChromaDbClient\Block\Adminhtml;
...
class Logo extends \Magento\Backend\Block\Template
{
    ...
    public const MODULE_NAME = 'Webkul_AIChromaDbClient';

    public const EXPIRE_CONFIG_PATH = 'aichromadbclient/webkul/logo_expire_time';

    public const LOGO_CONFIG_PATH = 'aichromadbclient/webkul/logo';
