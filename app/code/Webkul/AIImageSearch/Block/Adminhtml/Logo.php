 ...
 */
namespace Webkul\AIImageSearch\Block\Adminhtml;
...
class Logo extends \Magento\Backend\Block\Template
{
    ...
    public const EXPIRE_CONFIG_PATH = 'aiimagesearch/webkul/logo_expire_time';

    public const LOGO_CONFIG_PATH = 'aiimagesearch/webkul/logo';
