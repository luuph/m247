...
/**
 * RemoveFromCompare resolver
 */
class RemoveFromCompare extends AbstractCatalog implements ResolverInterface
{
    /**
     * @inheritdoc
     */
        ...
        try {
            ...
            if ($this->productId != 0) {
                ...
                if ($product) {
                    ...
                    $compareitem = $item->loadByProduct($product);
                    if ($item->getId()) {
                        $item->delete();
                    }
                    if ($compareitem) {
                        $this->listCompareModel->removeProduct($product);
