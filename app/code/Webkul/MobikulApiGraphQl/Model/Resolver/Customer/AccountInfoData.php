...
class AccountInfoData extends AbstractCustomer implements ResolverInterface
{
    ...
    public function resolve(
        ...
        try {
            ...
            $this->returnArray["customerToken"] = $this->customerToken;
            $this->returnArray["mobile"] = $this->customer->getData('mobilenumber');

            $customerData = $this->customer->getData();
            $customerTier = $customerData['mst_rewards_tier_id'] ?? null;
            if($customerTier == "1"){
                $customerTierValue = "Bronze";
            }
            if($customerTier == "2"){
                $customerTierValue = "Silver";
            }
            if($customerTier == "3"){
                $customerTierValue = "Gold";
            }
            if($customerTier == "4"){
                $customerTierValue = "Platinum";
            }
            if($customerTier == "5"){
                $customerTierValue = "Diamond";
            }
           
            // Add the specific value to the return array
            $this->returnArray['mstRewardsTierId'] = $customerTierValue ?? null;
