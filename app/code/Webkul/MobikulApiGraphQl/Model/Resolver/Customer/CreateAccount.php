...
$mobileCustomerCollection = $this->customerFactory->create()->getCollection()->addAttributeToFilter('mobilenumber', $this->mobile);
...
return $this->returnArray;
    ...
    protected function verifyRequest()
    {
        if ($this->getRequest()->getMethod() == "POST" && $this->wholeData) {
            ...
            $this->dob = isset($this->wholeData["dob"]) ? date("Y-m-d", strtotime($this->wholeData["dob"])) : "";
