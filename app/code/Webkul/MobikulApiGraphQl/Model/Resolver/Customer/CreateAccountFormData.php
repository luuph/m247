...
/**
 * CreateAccountFormData resolver
 */
class CreateAccountFormData extends AbstractCustomer implements ResolverInterface
{
    /**
     * @inheritdoc
     */
    public function resolve(
        ...
        try {
            ...
            $this->returnArray["dateFormat"] = DateTime::DATE_INTERNAL_FORMAT;
