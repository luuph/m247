 ...
 */
class OrderDetails extends AbstractCustomer implements ResolverInterface
{
    /**
     * @inheritdoc
     */
    public function resolve(
        ...
        try {
            ...
            if ($this->loadedOrder->getShippingAddress()) {
                ...
                $customerCustomAddressAttributes = $this->loadedOrder->getShippingAddress()->getCustomerAddressAttribute();
                if ($customerCustomAddressAttributes) {
                    $customerCustomAddressAttributes = json_decode($customerCustomAddressAttributes,true);
                    $shippingAddressArray[] = [
                        'id' => $this->loadedOrder->getShippingAddress()->getId(),
                        'address_title' => isset($customerCustomAddressAttributes['address_title']['value']) ? $customerCustomAddressAttributes['address_title']['value'] : '',
                        'apt_number' => isset($customerCustomAddressAttributes['apt_number']['value']) ? $customerCustomAddressAttributes['apt_number']['value'] : '',
                        'building_name' => isset($customerCustomAddressAttributes['building_name']['value']) ? $customerCustomAddressAttributes['building_name']['value'] : '',
                        'avenue' => isset($customerCustomAddressAttributes['avenue']['value']) ? $customerCustomAddressAttributes['avenue']['value'] : '',
                        'city' => $this->loadedOrder->getShippingAddress()->getCity(),
                        'city_id' => $this->loadedOrder->getShippingAddress()->getCityId(),
                        'country_id' => $this->loadedOrder->getShippingAddress()->getCountryId(),
                        'firstname' => $this->loadedOrder->getShippingAddress()->getFirstname(),
                        'floor' => isset($customerCustomAddressAttributes['floor']['value']) ? $customerCustomAddressAttributes['floor']['value'] : '',
                        'lastname' => $this->loadedOrder->getShippingAddress()->getLastname(),
                        'region' => $this->loadedOrder->getShippingAddress()->getRegion(),
                        'region_id' => $this->loadedOrder->getShippingAddress()->getRegionId(),
                        'street' => implode(', ', $this->loadedOrder->getShippingAddress()->getStreet()),
                        'telephone' => $this->loadedOrder->getShippingAddress()->getTelephone(),
                    ];
                }else {
                    $shippingAddressArray[] = [
                        'id' => $this->loadedOrder->getShippingAddress()->getId(),
            ...
            $customerCustomAddressAttributes = $this->loadedOrder->getBillingAddress()->getCustomerAddressAttribute();
            if ($customerCustomAddressAttributes) {
                $customerCustomAddressAttributes = json_decode($customerCustomAddressAttributes,true);
                $billingAddressArray[] = [
                    'id' => $this->loadedOrder->getBillingAddress()->getId(),
                    'address_title' => isset($customerCustomAddressAttributes['address_title']['value']) ? $customerCustomAddressAttributes['address_title']['value'] : '',
                    'apt_number' => isset($customerCustomAddressAttributes['apt_number']['value']) ? $customerCustomAddressAttributes['apt_number']['value'] : '',
                    'building_name' => isset($customerCustomAddressAttributes['building_name']['value']) ? $customerCustomAddressAttributes['building_name']['value'] : '',
                    'avenue' => isset($customerCustomAddressAttributes['avenue']['value']) ? $customerCustomAddressAttributes['avenue']['value'] : '',
                    'city' => $this->loadedOrder->getBillingAddress()->getCity(),
                    'city_id' => $this->loadedOrder->getBillingAddress()->getCityId(),
                    'country_id' => $this->loadedOrder->getBillingAddress()->getCountryId(),
                    'firstname' => $this->loadedOrder->getBillingAddress()->getFirstname(),
                    'lastname' => $this->loadedOrder->getBillingAddress()->getLastname(),
                    'floor' => isset($customerCustomAddressAttributes['floor']['value']) ? $customerCustomAddressAttributes['floor']['value'] : '',
                    'region' => $this->loadedOrder->getBillingAddress()->getRegion(),
                    'region_id' => $this->loadedOrder->getBillingAddress()->getRegionId(),
                    'street' => implode(', ', $this->loadedOrder->getBillingAddress()->getStreet()),
                    'telephone' => $this->loadedOrder->getBillingAddress()->getTelephone(),
                ];
            }else {
                $billingAddressArray[] = [
                    'id' => $this->loadedOrder->getBillingAddress()->getId(),
    ...
    protected function orderDetailsnTotals()
    {
        ...
        foreach ($items as $item) {
            ...
            if ($this->priceBlock->displayPriceInclTax() ||
                $this->priceBlock->displayBothPrices()
            ) {
                $eachItem["price"] = $this->loadedOrder
                    ->formatPriceTxt(
                        $this->priceBlock
    ...
    /**
     * GetCreditMemoItemData function
     *
     * @param mixed $item
     * @return void
     */
