...
/**
 * CustomCollection resolver
 */
class CustomCollection extends AbstractMobikul implements ResolverInterface
{
    /**
    ...
    public function resolve(
        ...
        try {
            ...
            $customFilterData = $this->serializer->unserialize($notification->getFilterData());
            ...
            foreach ($productCollection as $eachProduct) {
                ...
                if ($eachProduct->isAvailable() ||
                    (bool)$this->helper->getConfigData("cataloginventory/options/show_out_of_stock")
                ) {
                    $this->returnArray["productList"][] = $this->helperCatalog->getOneProductRelevantData(
                        $eachProduct,
                        $this->storeId,
                        $this->width,
                        $this->customerId
            ...
            if ($this->quoteId != 0) {
                $this->returnArray["cartCount"] = (int) $this->quote->setStoreId($this->storeId)->load($this->quoteId)
                    ->getItemsQty() * 1;
            }
    ...
    /**
     * GetFilteredProductCollection function
     *
