...
{
    public const APP_TEMPLATE = 'Webkul_MobikulCore::system/config/darkappdemo.phtml';
    ...
    {
        return $this->helper->getConfigData('mobikul/dark_mode_config/dark_app_theme_color') ?? '#ff8a80';
    }
    ...
    {
        return $this->helper->getConfigData('mobikul/dark_mode_config/dark_app_theme_text_color') ?? '#ffffff';
    }
    ...
    {
        return $defaultButtonColor = $this->helper->getConfigData(
