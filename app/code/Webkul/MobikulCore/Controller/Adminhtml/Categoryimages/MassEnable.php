...
/**
 * Class MassEnable controller
 */
class MassEnable extends \Webkul\MobikulCore\Controller\Adminhtml\Categoryimages
{
    /**
    ...
    public function execute()
    {
        ...
        $collection->setCategoryimagesData($coditionData, ["status"=>1]);
