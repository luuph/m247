...
class Save extends \Webkul\MobikulCore\Controller\Adminhtml\Featuredcategories
{
    ...
    public function execute()
    {
        ...
        if ($originalRequestData) {
            try {
                ...
                if (!isset($featuredcategoriesData['filename'][0]['path']) &&
                    isset($featuredcategoriesData['filename'][0]['url'])
                ) {
                    $url = $featuredcategoriesData['filename'][0]['url'];
                    $newUrl = explode('media/', $url);
                    $featuredcategoriesData["filename"] = $newUrl[1];
                } else {
    ...
    /**
     * GetFeaturedcategoriesImageName function
     *
     * @param mixed $featuredcategoriesData
     * @return void
     */
    ...
    /**
     * GetFeaturedcategoriesStoreId function
     *
     * @param mixed $featuredcategoriesData
     * @return void
     */
