    ...
    public function execute()
    {
        ...
        foreach ($collection->getAllIds() as $key => $notificationId) {
            ...
            try {
                ...
                $androidresult = $this->curl->getBody();
                // for ios //////////////////////////////////////////////////////////
                $fields = [
                    "to" => "/topics/".$iosTopic,
                    "data" => $message,
                ...
                $logData = [
                    ...
                    'ios_result' => $iosresult,
                    'public_ip' => $this->remoteAddress->getRemoteAddress()
                ];
                $this->helper->printlog($logData, 1, 'mobikul_notification.log');
