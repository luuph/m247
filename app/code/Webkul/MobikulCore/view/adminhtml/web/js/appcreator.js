        ...
        _create: function () {
            ...
            $( document ).ready(function() {
                $('.list-group-item').on('click', function(element){
                    ...
                    var wesiteId = $('#websites').find(":selected").val();
                    $.ajax({
                      url: self.options.updateUrl,
                      data: { data:url, website_id:wesiteId},
                      dataType: "json"
                    }).done(function (data) {
                  ...
                  $('#websites').on('change', function(element){
                    var website_id = $('#websites').find(':selected').val();
                    var redirect_url = self.options.requestUrl+'website_id/'+website_id;
                  ...
                  $( "#items").sortable({
                    ...
                    update: function (event, ui) {
                      var wesiteId = $('#websites').find(":selected").val();
                        ...
                        $.ajax({
                            url: self.options.updateUrl,
                            data: { data:ids, website_id: wesiteId},
                            dataType: "json"
                        }).done(function (data) {
                          if (data['success'] == true) {
                            var html = "";
