 ...
 */
namespace Webkul\WebAr\Block\Adminhtml;
...
class Logo extends \Magento\Backend\Block\Template
{
    ...
    public const MODULE_NAME = 'Webkul_WebAr';

    public const EXPIRE_CONFIG_PATH = 'webar/webkul/logo_expire_time';

    public const LOGO_CONFIG_PATH = 'webar/webkul/logo';
